...
dotnet restore "N8sIPScanner.csproj" -r win-x64 --ignore-failed-sources -v minimal
if errorlevel 1 goto fail

echo.
echo Publishing self-contained win-x64 app...
dotnet publish "N8sIPScanner.csproj" -c Release -r win-x64 --self-contained true --no-restore -p:PublishSingleFile=false -o "%~dp0dist-self-contained"
if errorlevel 1 goto fail

echo.
echo Done.
echo EXE created here:
echo %~dp0dist-self-contained\N8s-IPScanner.exe
echo.
pause
exit /b 0
